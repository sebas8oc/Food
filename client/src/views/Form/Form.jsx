...
//           />
//           {errors.title && (
//             <span className={style.error}>Please enter a title</span>
//           )}
//         </label>
//         <br />
...
//           />
//           {errors.image && (
//             <span className={style.error}>Please enter an image URL</span>
//           )}
//         </label>
//         <br />
...
//           />
//           {errors.summary && (
//             <span className={style.error}>Please enter a summary</span>
//           )}
//         </label>
//         <br />
...
//             value={healthScore}
//             onChange={(e) => {
//               setHealthScore(e.target.valueAsNumber);
//               setErrors({ ...errors, healthScore: false });
//             }}
//           />
//           {errors.healthScore && (
//             <span className={style.error}>
//               Please enter a health score between 1 and 100
//             </span>
//           )}
//         </label>
//         <br />
...
//           />
//           {errors.step && (
//             <span className={style.error}>Please enter the steps</span>
//           )}
//         </label>
//         <br />
...
//         </div>
//         {errors.diets && (
//           <span className={style.error}>Please select at least one diet</span>
//         )}
//         <br />
